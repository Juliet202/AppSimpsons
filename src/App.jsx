...
function App() {
  ...
  const consultarAPI = async () => {
    try {
      //cambiar el valor de set mostrarspiner para que se vea el componente spiner 
      ...
      setPersonaje(dato[0]);
      //cambiar el valor de mostrarspiner para que se vea la frase 
  ...
  //(condicion logica)?(codigo si se cumple la condicion logica):(logica si no se cumple la condicion) ESTO SE USA SI ES CORTO
  //const componenteCondicional = (mostrarSpiner) FORMA IMPLICITA
